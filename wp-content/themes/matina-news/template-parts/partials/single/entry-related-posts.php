...
$related_posts_options = get_theme_mod( 'matina_news_single_posts_related_posts_option', true );

if ( true !== $related_posts_options ) {
    return;
}

$related_section_title  = get_theme_mod( 'matina_news_single_related_title', __( 'You May Like', 'matina-news' ) );
$posts_column           = apply_filters( 'matina_news_single_related_posts_columns', 3 );
$row_count              = apply_filters( 'matina_news_single_related_posts_rows', 1 );
$related_taxonomy       = apply_filters( 'matina_news_single_posts_related_taxonomy', 'category' );
$related_layout         = apply_filters( 'matina_news_single_posts_related_layout', 'layout-default' );
...
/**
 * matina_news_before_single_entry_related_posts hook
 *
 * @since 1.0.0
 */
do_action( 'matina_news_before_single_entry_related_posts' );
?>
...
<?php
/**
 * matina_news_after_single_entry_related_posts hook
 *
 * @since 1.0.0
 */
do_action( 'matina_news_after_single_entry_related_posts' );