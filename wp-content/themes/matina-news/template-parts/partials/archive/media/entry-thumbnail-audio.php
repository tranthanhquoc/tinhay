...
/**
 * matina_news_before_single_entry_thumbnail hook
 *
 * @since 1.0.0
 */
do_action( 'matina_news_before_single_entry_thumbnail' );
?>
    ...
    ?>
        <div class="post-format-media post-format-media--audio">
            <div class="post-format-audio">
                <?php echo wp_kses_post( $get_audio[0] ); // WPCS xss ok. ?>
            </div>
...
<?php
/**
 * matina_news_after_single_entry_thumbnail hook
 *
 * @since 1.0.0
 */
do_action( 'matina_news_after_single_entry_thumbnail' );
