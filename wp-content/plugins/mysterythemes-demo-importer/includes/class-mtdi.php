...
if( ! class_exists( 'MTDI' ) ) :
	...
	class MTDI extends MTDI_Library {
		...
		public function get_supported_themes() {
			...
			$mt_free_themes = array( 'color-blog', 'easy-store', 'edigital', 'editorial', 'faceblog', 'flexible-lite', 'flexible', 'fotogenic', 'mismo', 'news-portal', 'owner', 'saaya', 'scholarship', 'swipewp', 'swipe', 'uniform', 'wp-diary', 'shopay', 'foodie-diary', 'matina', 'matina-news', 'newshive', 'color-blog-dark' );
