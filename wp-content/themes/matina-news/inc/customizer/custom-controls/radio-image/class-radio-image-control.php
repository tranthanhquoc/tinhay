...
if ( ! class_exists( 'Matina_News_Control_Radio_Image' ) ) {
     ...
     * @since 1.0.0
     */
	class Matina_News_Control_Radio_Image extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'matina-news-radio-image-style', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radioimage.css', null );
            wp_enqueue_script( 'matina-news-radio-image-script', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radioimage.js', array( 'jquery' ), false, true );
        }
