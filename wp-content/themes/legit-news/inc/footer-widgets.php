...
class Light_News_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'legit_news';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'legit-news' ), $i ),
...
// Initialize.
$legit_news_footer_widgets = new Light_News_Footer_Widgets();
