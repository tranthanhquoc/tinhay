...
add_action( 'customize_register', 'matina_news_register_general_typography_fields' );

if ( ! function_exists( 'matina_news_register_general_typography_fields' ) ) :

    /**
     * Register Typography section's fields.
     */
    function matina_news_register_general_typography_fields ( $wp_customize ) {
        ...
        $wp_customize->add_section( new Matina_News_Customize_Section(
            $wp_customize, 'matina_news_section_typography',
                array(
                    'priority'      => 60,
                    ...
                    'theme_options' => '',
                    'title'         => __( 'Typography', 'matina-news' )
                )
            )
        );
/*=================================================================================*/
         ...
         */
        $wp_customize->add_section( new Matina_News_Customize_Section(
            $wp_customize, 'matina_news_section_body_typography',
                array(
                    'priority'      => 10,
                    'panel'         => 'matina_news_theme_options_panel',
                    'section'       => 'matina_news_section_typography',
                    'capability'    => 'edit_theme_options',
                    'theme_options' => '',
                    'title'         => __( 'Body', 'matina-news' )
                )
            )
        );
        ...
        $wp_customize->add_control( new Matina_News_Control_Typography (
            $wp_customize,
                'body_typography',
                array(
                    'priority'      => 10,
                    'section'       => 'matina_news_section_body_typography',
                    'settings'      => array(
                        'family'    => 'body_font_family',
                        'style'     => 'body_font_style',
                    ),
                    'description'   => __( 'Select how you want your body fonts to appear.', 'matina-news' ),
        ...
        $wp_customize->add_control( 'body_text_transform',
            array(
                ...
                'label'             => __( 'Text Transform', 'matina-news' ),
                'type'              => 'select',
                'choices'           => matina_news_font_transform_choices()
            )
        );
...
/*=================================================================================*/
         ...
         */
        $wp_customize->add_section( new Matina_News_Customize_Section(
            $wp_customize, 'matina_news_section_h1_typography',
                array(
                    'priority'      => 20,
                    'panel'         => 'matina_news_theme_options_panel',
                    'section'       => 'matina_news_section_typography',
                    'capability'    => 'edit_theme_options',
                    'theme_options' => '',
                    'title'         => __( 'Heading 1 (H1)', 'matina-news' )
                )
            )
        );
        ...
        $wp_customize->add_control( new Matina_News_Control_Typography (
            $wp_customize,
                ...
                array(
                    'priority'      => 35,
                    'section'       => 'matina_news_section_h1_typography',
                    'settings'      => array(
                        'family'    => 'h1_font_family',
                        'style'     => 'h1_font_style',
                    ),
                    'description'   => __( 'Select how you want your H1 fonts to appear.', 'matina-news' ),
                    'l10n'          => array() // Pass custom labels. Use the setting key (above) for the specific label.
                )
            )
        );
...
/*=================================================================================*/
         ...
         */
        $wp_customize->add_section( new Matina_News_Customize_Section(
            $wp_customize, 'matina_news_section_h2_typography',
                array(
                    'priority'      => 30,
                    'panel'         => 'matina_news_theme_options_panel',
                    'section'       => 'matina_news_section_typography',
                    'capability'    => 'edit_theme_options',
                    'theme_options' => '',
                    'title'         => __( 'Heading 2 (H2)', 'matina-news' )
                )
            )
        );
        ...
        $wp_customize->add_control( new Matina_News_Control_Typography (
            $wp_customize,
                ...
                array(
                    'priority'      => 60,
                    'section'       => 'matina_news_section_h2_typography',
                    'settings'      => array(
                        'family'    => 'h2_font_family',
                        'style'     => 'h2_font_style',
                    ),
                    'description'   => __( 'Select how you want your H2 fonts to appear.', 'matina-news' ),
                    'l10n'          => array() // Pass custom labels. Use the setting key (above) for the specific label.
                )
            )
        );
...
/*=================================================================================*/
         ...
         */
        $wp_customize->add_section( new Matina_News_Customize_Section(
            $wp_customize, 'matina_news_section_h3_typography',
                array(
                    'priority'      => 40,
                    'panel'         => 'matina_news_theme_options_panel',
                    'section'       => 'matina_news_section_typography',
                    'capability'    => 'edit_theme_options',
                    'theme_options' => '',
                    'title'         => __( 'Heading 3 (H3)', 'matina-news' )
                )
            )
        );
        ...
        $wp_customize->add_control( new Matina_News_Control_Typography (
            $wp_customize,
                ...
                array(
                    'priority'      => 80,
                    'section'       => 'matina_news_section_h3_typography',
                    'settings'      => array(
                        'family'    => 'h3_font_family',
                        'style'     => 'h3_font_style',
                    ),
                    'description'   => __( 'Select how you want your H3 fonts to appear.', 'matina-news' ),
                    'l10n'          => array() // Pass custom labels. Use the setting key (above) for the specific label.
                )
            )
        );
...
/*=================================================================================*/
         ...
         */
        $wp_customize->add_section( new Matina_News_Customize_Section(
            $wp_customize, 'matina_news_section_h4_typography',
                array(
                    'priority'      => 50,
                    'panel'         => 'matina_news_theme_options_panel',
                    'section'       => 'matina_news_section_typography',
                    'capability'    => 'edit_theme_options',
                    'theme_options' => '',
                    'title'         => __( 'Heading 4 (H4)', 'matina-news' )
                )
            )
        );
        ...
        $wp_customize->add_control( new Matina_News_Control_Typography (
            $wp_customize,
                ...
                array(
                    'priority'      => 105,
                    'section'       => 'matina_news_section_h4_typography',
                    'settings'      => array(
                        'family'    => 'h4_font_family',
                        'style'     => 'h4_font_style',
                    ),
                    'description'   => __( 'Select how you want your H4 fonts to appear.', 'matina-news' ),
                    'l10n'          => array() // Pass custom labels. Use the setting key (above) for the specific label.
                )
            )
        );
